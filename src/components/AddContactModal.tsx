    ...
    >
      ...
      >
        <div className="flex justify-between items-center">
          <h3 className="text-lg font-bold text-slate-900 dark:text-white">Add New Contact</h3>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 mt-4">
          <div>
            ...
            <div className="relative">
              ...
              <input id="add-contact-name-textbox" type="text" required placeholder="e.g. Pastor Mark"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input id="add-contact-phone-textbox" type="text" required placeholder="+91 XXXXX XXXXX"
          ...
          <div className="flex gap-2 justify-end mt-2">
            ...
            <button id="add-contact-submit-btn" type="submit" className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-semibold rounded-lg transition-all cursor-pointer shadow-sm active:scale-95">
              Save Contact
            </button>
          </div>
        </form>
